...
/*
 * Attempts to enumerate all trees with a given degree sequence
 * @param {array} degreeSeq - Array of vertex degrees. Needn't be ordered.
 ...
 * N.B. Currently (edges describing) trees which are duplicates up to isomorphism are NOT removed from the returned array.
 * Plan is to implement the isomorphic check being worked on by Ben Nicholson in removeIsomorphic() below.
 *
 * Example code using the return of this function (assume let cy = phCytoscape(...) has been initialised).
 * 
